 ...
 546  003f 54            	srlw	x
 547  0040 54            	srlw	x
 548  0041 1f05          	ldw	(OFST-1,sp),x
 549                     ; 153   if ((4U * A) >= ((lsifreqkhz - (4U * A)) * (1U + (2U * A))))
 551  0043 58            	sllw	x
 552  0044 58            	sllw	x
 553  0045 1f01          	ldw	(OFST-5,sp),x
 554  0047 1e03          	ldw	x,(OFST-3,sp)
 555  0049 72f001        	subw	x,(OFST-5,sp)
 556  004c 1605          	ldw	y,(OFST-1,sp)
 557  004e 9058          	sllw	y
 558  0050 905c          	incw	y
 559  0052 cd0000        	call	c_imul
 561  0055 1605          	ldw	y,(OFST-1,sp)
 562  0057 9058          	sllw	y
 563  0059 bf00          	ldw	c_x,x
 564  005b 9058          	sllw	y
 565  005d 90b300        	cpw	y,c_x
 566  0060 7b06          	ld	a,(OFST+0,sp)
 567  0062 2504          	jrult	L761
 568                     ; 155     AWU->APR = (uint8_t)(A - 2U);
 570  0064 a002          	sub	a,#2
 572  0066 2001          	jra	L171
 573  0068               L761:
 574                     ; 159     AWU->APR = (uint8_t)(A - 1U);
 576  0068 4a            	dec	a
 577  0069               L171:
 578  0069 c750f1        	ld	20721,a
 579                     ; 161 }
 582  006c 5b06          	addw	sp,#6
 583  006e 81            	ret	
 ...
 673  0000 720a50f002    	btjt	20720,#5,L44
 674  0005 4f            	clr	a
 676  0006 81            	ret	
 677  0007               L44:
 678  0007 a601          	ld	a,#1
 681  0009 81            	ret	
 716                     	xdef	_TBR_Array
 717                     	xdef	_APR_Array
 ...
 725                     	switch	.const
 726  002e               L501:
 727  002e 2e2e5c2e2e5c  	dc.b	"..\..\..\..\librar"
 728  0040 6965735c7374  	dc.b	"ies\stm8s_stdperip"
 729  0052 685f64726976  	dc.b	"h_driver\src\stm8s"
 730  0064 5f6177752e63  	dc.b	"_awu.c",0
 731                     	xref.b	c_lreg
 732                     	xref.b	c_x
 752                     	xref	c_imul
 753                     	xref	c_ludv
