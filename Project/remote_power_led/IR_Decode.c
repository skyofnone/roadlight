...
uint8_t flag_IR_read_over = 0;  //20msÒç³ö±êÖ¾Î»
uint8_t IR_data[4] = {0};
uint8_t IrKey_Value = 0;
uint8_t key_status = 0;
uint16_t key_press_counter = 0;
uint16_t no_key_press_counter = 0;
extern bool flag_system_power;
extern uint8_t  flag_mode_current;
extern uint8_t cnt_time_fen_current;	//æœ€å¤§15
extern uint8_t cnt_time_shi_current;	//æœ€å¤§15

extern uint8_t cnt_time_fen_set1;	//æœ€å¤§15
extern uint8_t cnt_time_shi_set1;	//æœ€å¤§15
extern uint8_t cnt_time_fen_set2;	//æœ€å¤§15
extern uint8_t cnt_time_shi_set2;	//æœ€å¤§15
extern uint8_t cnt_vol_current;	//æœ€å¤§15
...
uint8_t Receive_IR_Dat(void)
{
	...
	if(WL > 1000) //¼ì²âµ½µÄÊÇÒýµ¼ÂëµÍµçÆ½²¿·Ö
	{
		//HW = HighPulseWidth(); 
