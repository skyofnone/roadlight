...
1293  001e 4f            	clr	a
1294  001f               L305:
1295                     ; 334   return ((FlagStatus)bitstatus);
1299  001f 85            	popw	x
1300  0020 81            	ret	
1336                     ; 344 void TIM4_ClearFlag(TIM4_FLAG_TypeDef TIM4_FLAG)
1336                     ; 345 {
1337                     .text:	section	.text,new
1338  0000               _TIM4_ClearFlag:
1340  0000 88            	push	a
1341       00000000      OFST:	set	0
1344                     ; 347   assert_param(IS_TIM4_GET_FLAG_OK(TIM4_FLAG));
1346  0001 4a            	dec	a
1347  0002 270e          	jreq	L002
1348  0004 ae015b        	ldw	x,#347
...
1356  0012               L002:
1357                     ; 350   TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
